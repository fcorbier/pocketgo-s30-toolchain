/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/opt/disk/part2/guoxs/zkswe_tina3.5/tina/out/astar-zkswe/compile_dir/toolchain/gcc-linaro-6.4-2017.11/gcc/config/arm/arm.md'.  */
